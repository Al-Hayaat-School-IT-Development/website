...
## Definition of Done
<!-- DOD:BEGIN -->
- [ ] #1 File moved to `src/components/sections/CTASection.tsx`
- [ ] #2 Removed from `src/components/ui/index.ts`
- [ ] #3 Added to `src/components/sections/index.ts`
- [ ] #4 All 8 page imports updated — zero TypeScript errors
- [ ] #5 All pages render CTASection identically post-move
...
Migrated CTASection from src/components/ui/ to src/components/sections/. Added CTASection and CTASectionProps exports to src/components/sections/index.ts. Removed CTASection export from src/components/ui/index.ts. Updated import paths in all 8 consuming pages: page.tsx, about/page.tsx, curriculum/page.tsx, admissions/page.tsx, contact/page.tsx, donate/page.tsx, school-plan/page.tsx, and careers/elementary-school-teacher/page.tsx. npx tsc --noEmit exits with code 0.
