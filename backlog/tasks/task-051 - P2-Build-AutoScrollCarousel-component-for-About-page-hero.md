...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Auto-scrolling carousel renders 6 school photos side by side with continuous leftward scroll animation
- [ ] #2 Carousel duplicates slides for seamless infinite loop (two sets of 6 images)
- [ ] #3 Images are 444px x 339px with border-radius 0.5rem and 1.6875rem gap between them
- [ ] #4 Carousel pauses on hover; resumes on mouse leave
